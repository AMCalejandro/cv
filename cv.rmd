...
# I did not get the deployment with Github Actions and workflows to work
# For now, I am hard coding a link to the github remote on the pdf

# if(params$pdf_mode){
#  cat("View this CV online with links at _AMCalejandro.github.io/cv/_")
# } else {
...
if(params$pdf_mode){
 cat("View this CV online with links at https://github.com/AMCalejandro/cv/")
} else {
 cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/AMCalejandro/cv/raw/gh-pages/amc_cv.pdf)")
}
